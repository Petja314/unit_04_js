...
function f1() {
    ...
    out.innerHTML = document.querySelector('.b-1').value = 1;
...
function f2() {
    ...
    out.innerHTML = document.querySelector('.i-2').value = 2;
}
...
function f3() {
    ...
    out.innerHTML = document.querySelector('.p-3').value = 3;
}
...
function f7() {
    ...
    let pw = document.querySelector('.i-7').value;
    outOne.innerHTML = pw;
    if (pw.length >= 6) {
        outTwo.innerHTML = 1;
    }
...
function f10() {
    ...
    out.innerHTML = a.value;
    out.style.backgroundColor = a.value;
}
...
function f11() {
    ...
    let b = document.querySelector('.i-112').value = a;
...
function f15() {
    ...
    let textPlace = document.querySelector('.t-15');
    let inp = document.querySelector('.i-15').value;

    out.innerHTML = inp;
    textPlace.innerHTML = inp;
}
...
function f20() {
    ...
    let b = document.querySelector('.s-202').value = a;
